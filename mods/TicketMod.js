...
module.exports = {
    ...
    version: "0.1.3",
    changelog: "Bug fixes lol ~ qizzle Schnitzel",
    isResponse: true,
    isMod: true,
    ...
    html: function(data) {
        return `
            ...
            <div class="form-group">
                ...
                <input name="namet" class="form-control needed-field" placeholder="You can use (username) for displaying the name of the user who reacted"></input>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="timedelete" class="form-control" placeholder="Leave the field blank to disabling that feature"></input>
            </div>
            <hr>
            <h1>Save variable</h1>
            <div class="form-group">
            ...
            DBS.Bot.on('messageReactionAdd', (reaction, user) => {
                if (reaction.message.id === msg.id) {
                    if (!user.bot) {
                        ...
                        message.guild.channels.create(ticketname.replace('(username)', user.username), {type: 'text'}).then(channel => {
